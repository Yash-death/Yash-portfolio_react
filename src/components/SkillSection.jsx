...
const skills = [
  ...
  { name: "ASP.NET Core (Razor Pages)", level: 70, category: "backend" },
  { name: "Microsoft SQL Server", level: 75, category: "backend" },
  { name: "SQL", level: 75, category: "backend" },
  { name: "Core Java", level: 80, category: "backend" },
  { name: "Batch Scripting", level: 65, category: "backend" },
  ...
  { name: "Adobe Illustrator", level: 80, category: "tools" }
];
